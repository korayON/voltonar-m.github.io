        ...
        <div className="md:w-11/12 mx-auto flex flex-col md:flex-row justify-between items-center gap-12">
          ...
          <motion.div
            ...
            <p className="md:w-3/4 text-sm text-neutralGrey mb-8">
              Yüksek gerilim hatları ve araç şarj istasyonları kurma konusundaki uzmanlığımız, elektrik altyapısının güvenilir ve etkili bir şekilde tasarlanması için bizi ideal bir tercih haline getiriyor. Tecrübeli ekibimiz ve kaliteli hizmet anlayışımız sayesinde projelerinizde en iyi sonuçları elde etmek için kararlıyız. Yenilikçi çözümleriz, enerji verimliliği ve sürdürülebilirlik odaklı yaklaşımız, müşterilerin ihtiyaçlarına özel çözümler sunmamızı sağlıyor. Elektrik altyapınızı güçlendirmek ve geleceğe dönük çözümlerle donatmak için bizimle çalışmanız, projelerinizin başarılı bir şekilde tamamlanması için doğru adım olacaktır.
            </p>
        ...
        <div className="flex flex-col md:flex-row justify-start items-center gap-8">
          ...
          <div className="md:w-2/3 mx-auto">
            <div>
              ...
              <h5 className="text-brandPrimary text-xl font-semibold mb-2">Koray Erdal</h5>
